...
# this stores the output of test data into a file called result.csv
def test(weights1, weights2):
    ...
    return predictions
# this is our basic function which does all the tasks. It loads the features from the given training set
# and trains the model on them. After that it modularise them in a pickle file and runs for the test data
if __name__ == '__main__':
    ...
    # model implemented using pickle
    W1 = weights1
    W2 = weights2
    n1 = featureDimension
    n2= hiddenLayerSize
    ...
    [W1_, W2_, n1_, n2_, n3_] = load_model('model.pkl')
    # results for test data are calculated in this function call
    predictions = test(W1_, W2_)
    print(predictions)
